...
global {
	...
	file shape_file_fusion <- file("../includes/fusion_t3.shp");
...
//--------------- image raster ------------
	...
	reflex metric when: cpt_trp_retour >= nb_trp - 1 {
		...
		if is_batch_impact_espace {
			...
			save [pct, std_pct, pcnt, std_pcnt,vitesse_aller, vitesse_retour, largeur_cellule, temp] rewrite: false to: "validation_espace_vitesse_t3_sa18_news.csv" type: csv;
		}
		...
		if is_batch_impact_tout_parametre {
			save [pct, std_pct, pcnt, std_pcnt, vitesse_aller, vitesse_retour, lambda1, lambda2, largeur_cellule, temp] rewrite: false to: "impact_tout_parametre_t3_sa20_news.csv" type:
			csv;
		}
...
species troupeau skills: [moving] {
	...
	init {
		if self.name = 'troupeau0' {
			self.terr_orig <- {294250.448524698, 209377.29635533012, 0.0};
			L_terr_acc <-
			[{294250.448524698, 209377.29635533012, 0.0}, {309340.2151157081, 218415.16526275442, 0.0}, {327447.9350249203, 209377.29635533012, 0.0}, {354355.5287183948, 202849.94658885698, 0.0}, {306307.3214345447, 162681.64033363777, 0.0}, {282178.6352518899, 128036.47618851122, 0.0}, {270106.8219790817, 125023.85321936978, 0.0}];
		} else if self.name = 'troupeau1' {
			self.terr_orig <- {127549.8620920027, 192088.38481474156, 0.0};
			L_terr_acc <-
			[{127549.8620920027, 192088.38481474156, 0.0}, {182586.17575122285, 197326.80447876436, 0.0}, {197675.942342233, 206364.6733861887, 0.0}, {267088.8686608797, 203352.05041704723, 0.0}, {270106.8219790817, 200339.4274479058, 0.0}, {276142.7286154858, 197326.80447876436, 0.0}, {276142.7286154858, 176238.4436947743, 0.0}];
		} else if self.name = 'troupeau2' {
			self.terr_orig <- {288214.5418882939, 185276.3126021986, 0.0};
			L_terr_acc <-
			[{288214.5418882939, 185276.3126021986, 0.0}, {339519.7482977284, 206364.6733861887, 0.0}, {357358.5416736355, 203854.15424523747, 0.0}, {361362.55894728965, 173727.92455382308, 0.0}];
		} else if self.name = 'troupeau3' {
			self.terr_orig <- {49796.22975033351, 140086.96806507697, 0.0};
			L_terr_acc <- [{49796.22975033351, 140086.96806507697, 0.0}, {93093.40161245968, 145610.11017516963, 0.0}];
		} else if self.name = 'troupeau4' {
			self.terr_orig <- {203711.84897863708, 176238.4436947743, 0.0};
			L_terr_acc <-
			[{203711.84897863708, 176238.4436947743, 0.0}, {227227.98027987467, 177744.755179345, 0.0}, {247248.06664814556, 179753.17049210597, 0.0}, {281282.21347420604, 181761.58580486692, 0.0}, {289290.24802151445, 185778.41643038884, 0.0}, {271272.1702900706, 163685.84799001826, 0.0}];
		} else if self.name = 'troupeau5' {
			self.terr_orig <- {276142.7286154858, 197326.80447876436, 0.0};
			L_terr_acc <-
			[{276142.7286154858, 197326.80447876436, 0.0}, {277278.19620055193, 177744.755179345, 0.0}, {267088.8686608797, 139584.86423688673, 0.0}, {261052.96202447562, 131049.09915765267, 0.0}, {242945.24211526345, 76821.88571310673, 0.0}, {227855.4755242533, 64771.39383654097, 0.0}];
		} else if self.name = 'troupeau6' {
			self.terr_orig <- {131280.96934178832, 185276.3126021986, 0.0};
			L_terr_acc <-
			[{131280.96934178832, 185276.3126021986, 0.0}, {171171.73844871615, 177744.755179345, 0.0}, {181181.78163285158, 177744.755179345, 0.0}, {197675.942342233, 176238.4436947743, 0.0}, {227855.4755242533, 161175.32884906707, 0.0}, {241242.04073766427, 139584.86423688673, 0.0}];
		} else if self.name = 'troupeau7' {
			self.terr_orig <- {149388.6892510005, 173225.82072563283, 0.0};
			L_terr_acc <-
			[{149388.6892510005, 173225.82072563283, 0.0}, {179568.2224330208, 170213.19775649137, 0.0}, {200693.89566043502, 155150.08291078417, 0.0}, {255017.05538807157, 161175.32884906707, 0.0}, {248981.14875166753, 143099.59103421844, 0.0}];
		} else {
			self.terr_orig <- {200693.89566043502, 206364.6733861887, 0.0};
			L_terr_acc <-
			[{200693.89566043502, 206364.6733861887, 0.0}, {258035.0087062736, 227453.03417017875, 0.0}, {291232.4952064959, 215402.54229361302, 0.0}, {327447.9350249203, 209377.29635533012, 0.0}, {354609.51488873863, 200339.4274479058, 0.0}];
		}
