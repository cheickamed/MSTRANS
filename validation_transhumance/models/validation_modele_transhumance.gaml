...
* 
*/
model validationmodeletranshumance
...
global {
	...
	file shape_file_fusion <- file("../includes/fusion.shp");
	...
	float vitesse_aller <- 12.0 min: 12.0 max: 21.0 parameter: 'Vitesse aller' category: "Mecanisme optimisation";
...
//--------------- image raster ------------
	...
	reflex metric when: cpt_trp_retour >= nb_trp - 1 {
		...
		//save [pct, std_pct, pcnt, std_pcnt, largeur_cellule, temp] rewrite: false to: "impact_espace_t_sa18_news.csv" type: csv;
			save [pct, std_pct, pcnt, std_pcnt, vitesse_aller, vitesse_retour, largeur_cellule, temp] rewrite: false to: "validation_espace_vitesse_t_sa18_news.csv" type: csv;
		}
		...
		if is_batch_impact_tout_parametre {
			save [pct, std_pct, pcnt, std_pcnt, vitesse_aller, vitesse_retour, lambda1, lambda2, largeur_cellule, temp] rewrite: false to: "impact_tout_parametre_t_sa18.csv" type: csv;
		}
...
species troupeau skills: [moving] {
	...
	init {
		if self.name = 'troupeau0' {
			self.terr_orig <- {190190.8204985735, 90378.68907424322, 0.0};
			L_terr_acc <-
			[{134134.578667415, 118496.50345289666, 0.0}, {106106.45775183575, 182765.7934612474, 0.0}, {114114.4922991441, 198833.1159633351, 0.0}, {110110.47502548993, 239001.4222185543, 0.0}, {130130.56139376081, 222934.09971646662, 0.0}, {134134.578667415, 234984.59159303235, 0.0}, {146146.63048837753, 202849.94658885698, 0.0}, {198198.85504588185, 210883.60783990085, 0.0}, {258035.0087062736, 227453.03417017875, 0.0}, {291232.4952064959, 215402.54229361302, 0.0}, {327447.9350249203, 209377.29635533012, 0.0}, {354355.5287183948, 202849.94658885698, 0.0}, {306307.3214345447, 162681.64033363777, 0.0}, {282283.2177926196, 130546.99532946243, 0.0}, {202202.87231953605, 98412.35032528706, 0.0}];
		} else if self.name = 'troupeau1' {
			self.terr_orig <- {224837.52220605125, 64771.39383654097, 0.0};
			L_terr_acc <-
			[{215783.66225144517, 79834.50868224818, 0.0}, {206729.80229683907, 100922.86946623825, 0.0}, {140334.82929639443, 140086.96806507697, 0.0}, {119209.1560689802, 149124.8369725013, 0.0}, {86011.66956875788, 152137.45994164277, 0.0}, {70921.90297774771, 152137.45994164277, 0.0}, {46778.276432131475, 137074.34509593557, 0.0}, {67903.94965954569, 158162.70587992563, 0.0}, {122227.10938718224, 194314.1815096229, 0.0}, {197675.942342233, 206364.6733861887, 0.0}, {267088.8686608797, 203352.05041704723, 0.0}, {270106.8219790817, 200339.4274479058, 0.0}, {276142.7286154858, 197326.80447876436, 0.0}, {276142.7286154858, 176238.4436947743, 0.0}, {267088.8686608797, 158162.70587992563, 0.0}, {261052.96202447562, 131049.09915765267, 0.0}, {242945.24211526345, 76821.88571310673, 0.0}];
		} else if self.name = 'troupeau2' {
			self.terr_orig <- {51051.22023909078, 139584.86423688673, 0.0};
			L_terr_acc <-
			[{51051.22023909078, 149626.94080069155, 0.0}, {113113.48798073056, 187786.83174314979, 0.0}, {179179.7729960245, 197828.9083069546, 0.0}, {199199.85936429538, 193812.07768143268, 0.0}, {265266.14437958936, 187786.83174314979, 0.0}, {357358.5416736355, 203854.15424523747, 0.0}, {361362.55894728965, 173727.92455382308, 0.0}];
		} else if self.name = 'troupeau3' {
			self.terr_orig <- {65065.28069688041, 159669.01736449637, 0.0};
			L_terr_acc <-
			[{73073.31524418877, 163685.84799001826, 0.0}, {91091.39297563257, 165694.26330277923, 0.0}, {105105.4534334222, 159669.01736449637, 0.0}, {109109.47070707638, 159669.01736449637, 0.0}, {115115.49661755763, 161677.4326772573, 0.0}, {117117.50525438473, 169711.09392830115, 0.0}, {125125.53980169308, 175736.33986658405, 0.0}, {117117.50525438473, 169711.09392830115, 0.0}, {105105.4534334222, 159669.01736449637, 0.0}, {91091.39297563257, 143601.69486240868, 0.0}, {73073.31524418877, 131551.2029858429, 0.0}, {67067.2893337075, 121509.12642203811, 0.0}, {73073.31524418877, 115483.88048375523, 0.0}, {71071.30660736168, 111467.04985823331, 0.0}, {49049.21160226369, 135568.03361136484, 0.0}, {49049.21160226369, 139584.86423688673, 0.0}, {93093.40161245968, 145610.11017516963, 0.0}];
		} else if self.name = 'troupeau4' {
			self.terr_orig <- {213213.919822085, 57239.83641368737, 0.0};
			L_terr_acc <-
			[{199199.85936429538, 75315.57422853602, 0.0}, {187187.80754333286, 101424.97329442849, 0.0}, {169169.72981188906, 115483.88048375523, 0.0}, {145145.62616996397, 139584.86423688673, 0.0}, {125125.53980169308, 157660.6020517354, 0.0}, {103103.44479659511, 187786.83174314979, 0.0}, {161161.6952645807, 173727.92455382308, 0.0}, {201201.8680011225, 177744.755179345, 0.0}, {227227.98027987467, 177744.755179345, 0.0}, {247248.06664814556, 179753.17049210597, 0.0}, {281282.21347420604, 181761.58580486692, 0.0}, {289290.24802151445, 185778.41643038884, 0.0}, {271272.1702900706, 163685.84799001826, 0.0}, {247248.06664814556, 93391.31204338465, 0.0}, {241242.04073766427, 75315.57422853602, 0.0}];
		} else if self.name = 'troupeau5' {
			self.terr_orig <- {227227.98027987467, 65273.497664731214};
			L_terr_acc <-
			[{217217.9370957392, 79332.40485405794, 0.0}, {207207.89391160375, 101424.97329442849, 0.0}, {105105.4534334222, 149626.94080069155, 0.0}, {93093.40161245968, 155652.18673897441, 0.0}, {111111.47934390348, 177744.755179345, 0.0}, {275276.1875637248, 197828.9083069546, 0.0}, {277278.19620055193, 177744.755179345, 0.0}, {267088.8686608797, 139584.86423688673, 0.0}];
		} else if self.name = 'troupeau6' {
			self.terr_orig <- {219219.9457325663, 31130.437347794887, 0.0};
			L_terr_acc <-
			[{209209.90254843087, 41172.513911599686, 0.0}, {195195.8420906412, 71298.7436030141, 0.0}, {187187.80754333286, 101424.97329442849, 0.0}, {173173.74708554323, 115483.88048375523, 0.0}, {117117.50525438473, 183770.0011176279, 0.0}, {81081.34979149712, 175736.33986658405, 0.0}, {59059.25478639914, 151635.35611345252, 0.0}, {83083.35842832421, 175736.33986658405, 0.0}, {119119.51389121183, 183770.0011176279, 0.0}, {171171.73844871615, 177744.755179345, 0.0}, {181181.78163285158, 177744.755179345, 0.0}, {241242.04073766427, 139584.86423688673, 0.0}, {195195.8420906412, 71298.7436030141, 0.0}];
		} else if self.name = 'troupeau7' {
			self.terr_orig <- {111111.47934390348, 151635.35611345252, 0.0};
			L_terr_acc <-
			[{119119.51389121183, 169711.09392830115, 0.0}, {149149.64344361814, 173727.92455382308, 0.0}, {201201.8680011225, 155652.18673897441, 0.0}, {255256.1011954539, 159669.01736449637, 0.0}, {253254.0925586268, 141593.2795496477, 0.0}, {209209.90254843087, 101424.97329442849, 0.0}, {217217.9370957392, 65273.497664731214, 0.0}, {209209.90254843087, 101424.97329442849, 0.0}, {139139.60025948274, 133559.61829860386, 0.0}, {49049.21160226369, 137576.44892412578, 0.0}, {51051.22023909078, 149626.94080069155, 0.0}, {69069.2979705346, 151635.35611345252, 0.0}, {103103.44479659511, 155652.18673897441, 0.0}, {123123.53116486601, 181761.58580486692, 0.0}, {169169.72981188906, 175736.33986658405, 0.0}, {191191.82481698706, 177744.755179345, 0.0}, {199199.85936429538, 177744.755179345, 0.0}, {211211.91118525795, 183770.0011176279, 0.0}, {213213.919822085, 201845.73893247652, 0.0}, {221221.9543693934, 189795.24705591076, 0.0}, {218801.61556964723, 185276.3126021986, 0.0}];
		} else {
			self.terr_orig <- {203711.84897863708, 100922.86946623825, 0.0};
			L_terr_acc <-
			[{61868.043023141625, 167200.57478734996, 0.0}, {7544.883295505076, 167200.57478734996, 0.0}, {49796.22975033351, 164187.9518182085, 0.0}, {107137.34279617207, 188288.93557134003, 0.0}, {167496.40916021267, 185276.3126021986, 0.0}, {200693.89566043502, 206364.6733861887, 0.0}, {291232.4952064959, 215402.54229361302, 0.0}, {327447.9350249203, 209377.29635533012, 0.0}, {354609.51488873863, 200339.4274479058, 0.0}, {282178.6352518899, 128036.47618851122, 0.0}];
		}
	...
	reflex retour_co when: fin_transhumance and presence_terr_orig = 0 {
		...
		do goto target: the_target;
		my_cell.location <- self.location;
		if self.location = terr_orig or (self.location.y < terr_orig.y) {
			presence_terr_orig <- 1;
			the_target <- nil;
			//arrive_orig <- false;
		}
	...
	//---------------------------- fonction d'optimisation du choix du trajet --------------
		...
		//La phase retour de la transhumance
			...
			} else { // permet d'être sur que le troupeau retournera dans son campement d'origine mais est rarement réalisé: condition dexistence de solution du problème d'optimisation
				the_target <- terr_orig;
			}
...
experiment impact_dimension_espace type: batch repeat: 17 until: cpt_trp_retour >= nb_trp or cycle >= 400 {
	...
	/*parameter 'pourcentage_reduction_veg' var: lambda1 <- 0.5;
	parameter 'pourcentage_reduction' var: lambda2 <- 0.5;*/
//parameter 'vitesse_aller' var: vitesse_aller <- 17.0;
	//parameter 'vitesse_retour' var: vitesse_retour <- 19.0;
}
//----------------------------------------- Batch vitesse moyenne de déplacement des troupeaux ------
experiment impact_vitesse type: batch repeat: 30 until: cpt_trp_retour >= nb_trp or cycle >= 400 {
...
experiment impact_tout_parametre type: batch repeat: 3 until: cpt_trp_retour >= nb_trp or cycle >= 350 {
	parameter 'Batch_impact_tout_parametre' var: is_batch_impact_tout_parametre <- true;
	parameter 'dimension_espace' var: largeur_cellule <- 18 #km; //min: 30 #km step: 3 #km max: 36 #km;
	parameter 'vitesse_aller' var: vitesse_aller <- 12.0 min: 12.0 step: 3 max: 22.0;
